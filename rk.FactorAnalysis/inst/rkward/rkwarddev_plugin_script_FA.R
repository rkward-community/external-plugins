...
about.info <- rk.XML.about(
	...
	about=list(desc="RKWard GUI to conduct principal component and factor analysis",
		version="0.01-13", url="https://rkward.kde.org", long.desc="RKWard GUI to conduct principal component and factor analysis (using the psych package). Also includes dialogs for scree plots, correlation plots, VSS/MAP and parallel analysis.")
	)
